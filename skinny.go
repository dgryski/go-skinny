// Package skinny implements the SKINNY lightweight cipher
/*
...
/* Translation of the reference C code */

// Table that encodes the parameters of the various Skinny versions:
// (block size, key size, number of rounds)
var versions = [6][3]int{
	{64, 64, 32},   //Skinny-64-64: 32 rounds
	{64, 128, 36},  //Skinny-64-128: 36 rounds
	{64, 192, 40},  //Skinny-64-192: 40 rounds
	{128, 128, 40}, //Skinny-128-128: 40 rounds
	{128, 256, 48}, //Skinny-128-256: 48 rounds
	{128, 384, 56}, //Skinny-128-384: 56 rounds
}
